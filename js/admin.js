...
function ouvrirFicheRecette(id) {
  ...
  document.getElementById('fiche-recette-contenu').innerHTML = `
    <div class="fiche-visuel" style="background:${rec.image_url ? 'url(\'' + rec.image_url + '\')' : (rec.couleur_hex || 'var(--beige)')}; background-size:cover; background-position:center; height:180px; margin-bottom:24px;"></div>
